    ...
    return (
        <div className="flex flex-col min-h-screen bg-background">
            ...
            <div className="flex-1 pb-32">
                {/* Gallery Placeholder */}
                <div className="aspect-[4/5] bg-system-gray-6 dark:bg-system-gray-5/10 flex items-center justify-center relative">
                    <span className="text-ios-caption2 uppercase tracking-widest text-system-gray font-bold">Transmission Image Pending</span>
                ...
                <div className="px-6 py-8 space-y-6">
                    <div className="space-y-1">
                        ...
                        <p className="text-ios-title3 text-system-blue font-semibold">{product.price}</p>
                    </div>

                    <div className="space-y-2">
                        <p className="text-ios-body leading-relaxed text-secondary-label">
                            {product.description}
                        </p>
                    </div>

                    <div className="space-y-3 pt-4">
                        <h3 className="text-ios-caption1 text-system-gray font-semibold uppercase tracking-wider">Specifications</h3>
                        <ul className="grid grid-cols-2 gap-3">
                            {product.features.map(f => (
                                <li key={f} className="flex items-center space-x-2 text-ios-footnote">
                                    <span className="w-1 h-1 bg-system-blue rounded-full" />
                                    <span>{f}</span>
                                </li>
                            ))}
                        </ul>
